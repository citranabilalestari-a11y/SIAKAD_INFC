...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO dsn (nidn, nama, gender, alamat, prodi) VALUES ('$nidn', '$nama', '$gender', '$alamat', '$prodi')";
    if ($db->query($sql)) {
        echo "<script>alert('Data berhasil disimpan!');window.location='?p=dosen';</script>";
    } else {
            ...
            <div class="card-body">
              <form method="post">
                ...
                <div class="mt-3 text-end">
                  ...
                  <a href="?p=dosen" class="btn btn-secondary px-4 ms-2">Batal</a>
                </div>
              </form>
            </div>
          </div> <!-- /card -->
